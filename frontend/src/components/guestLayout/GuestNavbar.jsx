        ...
        <>
            ...
            <Navbar collapseOnSelect expand="lg" variant="dark" bg="dark" className="custom-navbar navbarStyle">
                <Container>
                    ...
                    <Navbar.Brand as={NavLink} to="/user/home" className="navbar-brand brandStyle">
                        <img
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className="ms-auto">
                            <Nav.Link as={NavLink} to="/user/home" className="nav-item navItemStyle" >Home</Nav.Link>
                            <Nav.Link as={NavLink} to="/user/about" className="nav-item navItemStyle" >About</Nav.Link>
                            <Nav.Link as={NavLink} to="/user/temples" className="nav-item navItemStyle" >Temples</Nav.Link>
                            <Nav.Link as={NavLink} to="/user/festivel" className="nav-item navItemStyle" >Festivel</Nav.Link>
                            <Nav.Link as={NavLink} to="/user/cricket" className="nav-item navItemStyle" >Cricket</Nav.Link>
                           
                            <Nav.Link as={NavLink} to="/user/contact" className="nav-item navItemStyle" >Contact</Nav.Link>
                            <Nav.Link as={NavLink} to="/user/profile" className="nav-item navItemStyle" >Profile</Nav.Link>
